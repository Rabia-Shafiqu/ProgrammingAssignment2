...
makeCacheMatrix <- function(x = matrix())
 {
   ...
   {
      x <<- y ## caches the inputed matrix so that cacheSolve can check whether it has changed (note this is within the setmatrix function)

      i <<- NULL #sets the value of i(the matrix inverse if used cacheSolve) to Null
    }
